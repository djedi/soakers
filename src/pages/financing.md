  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7 mb-4">
        <h2>Easy, Affordable Financing</h2>
        <p style="font-size: 16px; line-height: 1.8;">
          We've partnered with <strong>Mountain America Credit Union</strong> to offer flexible financing options
          for your hot tub purchase. Whether you're looking at a cozy two-person spa or a full-size swim spa,
          there's a payment plan that fits your budget.
        </p>
        <p style="font-size: 16px; line-height: 1.8;">
        ...
        <ol style="font-size: 16px; line-height: 2;">
          ...
          <li><strong>Get approved</strong> — Fast decisions so you're not left waiting</li>
          <li><strong>Enjoy your hot tub</strong> — With comfortable monthly payments</li>
        </ol>
      </div>
        ...
        <div class="card border-0 shadow p-4 text-center" style="background: #f8f9fa; border-radius: 12px;">
          <div class="card-body">
            ...
            <p style="font-size: 13px; color: #888; margin-top: 15px;">
              You will be redirected to Mountain America Credit Union's secure site.
            </p>
          </div>
        </div>
      </div>
