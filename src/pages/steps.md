    ...
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4">
        <p style="font-size: 18px; line-height: 1.8;">
          All optional step accessories are made of a durable, synthetic material that can withstand the harshest weather conditions, including snow, humidity, rain, sleet, and heat.
        </p>
      </div>
...
<section class="pb-70" style="background-color: #f8f9fa;">
  <div class="container pt-70">
    <div class="text-center mb-50">
      <h2>Monarch Elite Steps</h2>
      <p style="font-size: 14px; color: #888;">Optional for Artesian Elite</p>
    </div>
    <div class="row text-center">
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
          ...
          <div class="card-body">
            <h4 style="color: #1168b7;">Mocha</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
          ...
          <div class="card-body">
            <h4 style="color: #1168b7;">Smoke</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mb-4">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 text-center">
        ...
        <h4 style="color: #1168b7; margin-top: 15px;">Modular Step</h4>
      ...
      <div class="col-lg-6 mb-4 text-center">
        ...
        <h4 style="color: #1168b7; margin-top: 15px;">5-Steps</h4>
...
<section class="site-cta">
  <div class="container text-center">
    ...
    <p style="font-size: 18px; max-width: 600px; margin: 0 auto 25px; color: rgba(255,255,255,0.9);">
      Learn more about all available step accessories from Artesian Spas.
    </p>
    <div>
      <a href="https://artesianspas.com/features-and-accessories/steps/" target="_blank" rel="noopener noreferrer" style="display: inline-block; background: white; color: #1168b7; margin: 5px; padding: 14px 30px 10px; font-size: 18px; font-weight: 500; border-radius: 5px; text-decoration: none;">
